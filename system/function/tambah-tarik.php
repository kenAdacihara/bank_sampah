<?php
 if (isset($_POST['simpan'])) {
  ...
  echo "<meta http-equiv='refresh'
   content='0; url=http://localhost:8080/bank-sampah/page/admin.php?page=tambah-data-tarik'>";
...
<body>
     <h2 style="font-size: 30px; color: #262626;">Tarik Tabungan, <a href="admin.php?page=data-tarik">
