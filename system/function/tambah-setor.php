<?php
 if (isset($_POST['simpan'])) {
  ...
  echo "<meta http-equiv='refresh'
   content='0; url=http://localhost:8080/bank-sampah/page/admin.php?page=data-setor'>";
...
<body>
		<h2 style="font-size: 30px; color: #262626;">Setor Sampah, <a href="admin.php?page=data-setor">
